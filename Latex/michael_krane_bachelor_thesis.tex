...
\input{content/chapters/titlePage}
\tableofcontents
...
\include{content/chapters/abstract}
\include{content/chapters/chapter1}	%Introduction
\include{content/chapters/chapter2} %Technical Background
\include{content/chapters/chapter3}	%Evaluation of SHAMPU
\include{content/chapters/chapter4} %Discussion
...
\begin{appendix}
\include{content/chapters/source} % Sourcecode
...
\include{content/chapters/clause} %It may be necessary that you replace "Bachelorarbeit" with "Masterarbeit" here...
