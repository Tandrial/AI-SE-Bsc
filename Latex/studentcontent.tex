...
In the end, while ANT is not the most powerful wireless solution available, its design choices (low power consumption and ease-of-use) overlap almost completely with the design goals of SHAMPU.
\newpage
\section{Future Work}
\label{sec:future}
