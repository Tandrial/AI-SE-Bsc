...
/**
 * A simple multi-objective local search algorithm which has a nullary and
 * a unary search operation.
 *
 * @param <G>
 ...
 * @author Thomas Weise
 */
public class MOLocalSearchAlgorithm<G, X> extends
    MOOptimizationAlgorithm<G, X> {
