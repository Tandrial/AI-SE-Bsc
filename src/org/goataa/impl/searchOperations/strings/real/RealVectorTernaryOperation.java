...
import org.goataa.impl.searchOperations.TernarySearchOperation;

/**
 * A base class for ternary vector operations
 *
 * @author Thomas Weise
 */
public class RealVectorTernaryOperation extends
    TernarySearchOperation<double[]> {
   ...
   */
  protected RealVectorTernaryOperation(final double mi, final double ma) {
    super();
    this.min = mi;
    this.max = ma;
  }
