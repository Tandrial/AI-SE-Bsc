...
/**
 * A mutation operation that wraps a tree and then simplifies it.
 *
 * @author Thomas Weise
 */
public class TreeWrapperRed extends TreeWrapper {
   ...
   *          the allowed node types
   */
  public TreeWrapperRed(final NodeTypeSet<?> al, final int md) {
    super(md);
    this.allowed = al;
  }
