 ...
 * @author Thomas Weise
 */
public class Node<CT extends Node<CT>> extends OptimizationModule
   ...
   */
  @Override
  public final String getConfiguration(final boolean longVersion) {
    StringBuilder sb;
  ...
  public void fillInText(final StringBuilder sb) {
    sb.append(super.getConfiguration(false));
  }
  ...
  public String toString(final boolean longVersion) {
    return this.getConfiguration(longVersion);
  }
