...
/**
 * Draw a elliptic shape. An arbitrary number of additional children can be
 * used for inner shapes.
 *
 * @author Thomas Weise
 */
public class Ellipse extends GraphicsNode {
   ...
   */
  public Ellipse(final Node<?>[] pchildren,
      final NodeType<Ellipse, RealFunction> in) {
  ...
  public void fillInText(final StringBuilder sb) {
    ...
    sb.append("drawEllipse(col="); //$NON-NLS-1$
